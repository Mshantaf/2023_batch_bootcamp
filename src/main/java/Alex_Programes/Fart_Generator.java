...
public class Fart_Generator {
    ...
    System.out.println("Enter your name and your birthday");
    
    Scanner scan = new Scanner (System.in);
    String latter = scan.next().toUpperCase();
    char cha = latter.charAt(0);
	...
	System.out.println(letters.get(cha) + "  ,"+ days.get(day));
	}
