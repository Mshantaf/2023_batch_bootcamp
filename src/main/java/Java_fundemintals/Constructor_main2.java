...
// عملت باراميتر كونستراكتور واستدعيته بكلمة سوبر في التشايلد كلاس وادخلت الباراميتر في كلمة سوبر وطبع مباشرة 
//بنقدر نستدعي ونطبع  باستعمال كلمة سوبر 
class school {
	String name ;
	  school() {
...
class student_3 extends school {
	 ...
	 System.out.println("name is "+ name);//طبع الموجود في كلمة سوبر
